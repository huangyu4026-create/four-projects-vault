...
2026-06-24 起，本目录只作为历史固定点和证据留档保留，不再作为坐标/咨询/聚拢查证类问题的主入口。后续主用入口改为：

`../../红楼梦人工智能咨询工程/`

本目录仍保留 2026-06-22 坐标升级时的发布验收、脚本、schema、表行数和清单，方便追溯当时的固定点；新问题、新成果登记和后续接续默认进入顶层 `红楼梦人工智能咨询工程/`。
