...
2026-06-23 又新增顶层 `坐标工程/`。它与 `red-mansion/05_coordinate_mapping_20260622/` 使用同一套坐标升级证据，但在 GitHub 上作为独立工程读取：先读 `坐标工程/README.md`，再读 `坐标工程/00_entry_and_route/000C_进入坐标查询_新窗口强制入口_候选正式头.md`。
