...
新增目录：`红楼梦早期工程_停用留档/05_coordinate_mapping_20260622/`。
...
2026-06-23 又新增顶层 `红楼梦人工智能咨询工程/`。它从早期红楼梦工程改造新生，并与 `红楼梦早期工程_停用留档/05_coordinate_mapping_20260622/` 承接同一套坐标升级证据，但在 GitHub 上作为新的独立主入口读取：先读 `红楼梦人工智能咨询工程/README.md`，再读 `红楼梦人工智能咨询工程/00_entry_and_route/000C_进入坐标查询_新窗口强制入口_候选正式头.md`。
