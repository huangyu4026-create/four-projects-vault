...
def main() -> int:
    ...
    report = {
        ...
        "current_receiver": "P05",
        "current_receiver_name": "煜个人生命立场系统",
        "current_authorization_mode": "P05-AUTH-* or USER-EXPLICIT-* per real request",
        "authorization_alignment": {
            "status": "LEGACY_PRESERVED_CURRENT_SEPARATED",
            "scope_changed": False,
            "note": "旧LWG材料按历史名称保留；数字生命2.0仍属于P01数字生命，当前已确认的跨工程接收方为P05。AI上下文八面只是载入组件。",
        },
        ...
        "next_valid_closure": {
            "required_receiver_requests": ["P05"],
            "required_chain": [
                "receiver_request",
